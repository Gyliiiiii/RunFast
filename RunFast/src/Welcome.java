...
public class Welcome extends JFrame implements MouseListener {
	...
	Welcome() {
		...
		allarea.setImageFile(new File("pics\\wel.png"));
		add(allarea);
		...
		LOGIN = new JLabel();
		LOGIN.setBounds(230, 250, 156, 36);
		LOGIN.setIcon(new ImageIcon("pics//starton.jpg"));
		LOGIN.addMouseListener(this);
		SET = new JLabel();
		SET.setBounds(230, 320, 156, 36);
		SET.setIcon(new ImageIcon("pics//seton.jpg"));
	...
	public void initloginarea() {
		...
		loginarea.setBounds(80, 100, 579, 261);
		loginarea.setIcon(new ImageIcon("pics\\log.jpg"));
		allarea.add(loginarea);
		loginid = new JTextField();
		loginid.setBounds(215, 155, 125, 25);
		loginarea.setLayout(null);
		loginarea.add(loginid);
		password = new JPasswordField();
		password.setEchoChar('*');
		password.setBounds(215, 193, 125, 28);
		loginarea.add(password);
		login = new JLabel();
		exit = new JLabel();
		register = new JLabel();
		login.setBounds(375, 135, 100, 40);
		login.setIcon(new ImageIcon("pics//button//loginbutton.png"));
		login.addMouseListener(this);
		register.setBounds(375, 175, 100, 40);
		register.setIcon(new ImageIcon("pics//button//register.png"));
		register.addMouseListener(this);
		exit.setBounds(375, 215, 100, 40);
	...
	public void mouseEntered(MouseEvent e) {
		...
		if (e.getSource() == LOGIN) {
			LOGIN.setBounds(225, 245, 156, 36);
			LOGIN.setIcon(new ImageIcon("pics//start1.png"));
		}
		if (e.getSource() == SET) {
			SET.setBounds(225, 315, 156, 36);
			SET.setIcon(new ImageIcon("pics//set.png"));
		}
		if (e.getSource() == close) {
